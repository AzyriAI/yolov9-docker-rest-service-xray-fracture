...
from src.yolov9.utils.general import (LOGGER, ROOT, Profile, colorstr,
                           increment_path, is_notebook,
                            xyxy2xywh, yaml_load)
from src.yolov9.utils.plots import Annotator, colors, save_one_box
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from src.yolov9.models.experimental import attempt_load  # scoped to avoid circular import
